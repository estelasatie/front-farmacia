  ...
  return (
    <div className='container w-1/3 mx-auto'>
      ...
      <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
        <header className='py-2 px-6 bg-red-600 text-white font-bold text-2xl'>Produtos</header>
        <div className="p-4">
        ...
        <div className="flex">
          ...
          <button className='w-full text-slate-100 bg-red-400 hover:bg-red-600 flex items-center justify-center' onClick={deletarProduto}>
            Sim
          </button>
        </div>
      </div>
